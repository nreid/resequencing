...
sourcedir=/home/nreid/popgen/nbu/140902_D00255_0102_BC52L8ACXX/FASTQ/Project_Killifish
bwadir=/home/nreid/popgen/alignments/bwamem/F12/
bowtiedir=/home/nreid/popgen/alignments/bowtie/F12
...
for lane in 8
	...
	fq1=$(echo $root $ind L00$lane R1 001.fastq.gz | sed 's/ /_/g')
	fq2=$(echo $root $ind L00$lane R2 001.fastq.gz | sed 's/ /_/g')
	rg=$(echo \@RG\\tID:$root.F12.L00$lane\\tPL:Illumina\\tPU:x\\tLB:BI_NBH_1\\tSM:$root)
	outroot=$(echo $root.F12.L00$lane.sort.rg)
	...
	#bwa command line
	cmdline=bwa\ mem\ $bwagenind\ -t\ 24\ -R\ $rg\ one.fifo\ two.fifo
	echo $cmdline
	...
	#bowtie command line	
	cmdline2=bowtie2\ --very-sensitive-local\ -q\ -p\ 24\ -x\ killifish20130322asm\ --rg-id\ $root.F12.L00$lane\ --rg\ PL:Illumina\ --rg\ PU:x\ --rg\ LB:BI_NBH_1\ --rg\ SM:$root\ -1\ one.fifo\ -2\ two.fifo
	echo $cmdline2
