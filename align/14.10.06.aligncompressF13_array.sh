...
sourcedir=/home/nreid/popgen/nbu/140520_D00255_0090_AC42C2ACXX/FASTQ/Project_Killifish
bwadir=/home/nreid/popgen/alignments/bwamem/F13/
bowtiedir=/home/nreid/popgen/alignments/bowtie/F13
...
for lane in 8
	...
	rg=$(echo \@RG\\tID:$root.F13.L00$lane\\tPL:Illumina\\tPU:x\\tLB:BI_NBH_1\\tSM:$root)
	outroot=$(echo $root.F13.L00$lane.sort.rg)
	...
	#bowtie command line	
	cmdline2=bowtie2\ --very-sensitive-local\ -q\ -p\ 24\ -x\ killifish20130322asm\ --rg-id\ $root.F13.L00$lane\ --rg\ PL:Illumina\ --rg\ PU:x\ --rg\ LB:BI_NBH_1\ --rg\ SM:$root\ -1\ one.fifo\ -2\ two.fifo
	echo $cmdline2
