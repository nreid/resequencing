...
sourcedir=/home/nreid/popgen/gpfs/projects/s-colboujk01/140521_D00255_0091_BC3PYMACXX/Unaligned/Project_DefaultProject
bwadir=/home/nreid/popgen/alignments/bwamem/F11/
bowtiedir=/home/nreid/popgen/alignments/bowtie/F11
...
for lane in {1..8}
	...
	rg=$(echo \@RG\\tID:$root.F11.L00$lane\\tPL:Illumina\\tPU:x\\tLB:BI_NBH_1\\tSM:$root)
	outroot=$(echo $root.F11.L00$lane.sort.rg)
	...
	#bowtie command line	
	cmdline2=bowtie2\ --very-sensitive-local\ -q\ -p\ 24\ -x\ killifish20130322asm\ --rg-id\ $root.F11.L00$lane\ --rg\ PL:Illumina\ --rg\ PU:x\ --rg\ LB:BI_NBH_1\ --rg\ SM:$root\ -1\ $fq1\ -2\ $fq2
	echo $cmdline2
