...
sourcedir=/home/nreid/popgen/Project_test_Jan/Project_DefaultProject/
bwadir=/home/nreid/popgen/alignments/bwamem/pilot2/
...
for lane in {3..5}
	...
	rg=$(echo \@RG\\tID:$root.F02.L00$lane\\tPL:Illumina\\tPU:x\\tLB:BI_NBH_1\\tSM:$root)
	outroot=$(echo $root.F02.L00$lane.sort.rg)
